...
limecoinxd/limecoinx-cli binaries are not included in the Bitcoin-Qt.app bundle.

If you are building `limecoinxd` or `Bitcoin-Qt` for others, your build machine should be set up
